...
static void write_index(const std::string& name, RAMDirectory* dir, IndexVersion index_version,
                        bool isDictCompress, const std::vector<std::string>& datas) {
...
void TestIndexByteArray(CuTest* tc) {
    ...
    store_v2::GrowableByteArrayDataOutput out;
    ...
    store_v2::ByteArrayDataInput in;
...
void TestIndexCompactionDicCompress(CuTest* tc) {
    std::srand(getDaySeed());
    ...
    std::cout << "\nTestIndexCompactionDicCompress sucess" << std::endl;
}

void TestIndexCompactionV3Exception(CuTest* tc) {
    std::srand(getDaySeed());
    ...
    RAMDirectory in_dir_v1;
    {
        ...
        write_index(name, &in_dir_v1, IndexVersion::kV3, true, datas);
    }
    ...
    RAMDirectory in_dir_v2;
    {
        ...
        write_index(name, &in_dir_v2, IndexVersion::kV3, false, datas);
    }
...
CuSuite* testIndexCompressV3() {
    ...
    SUITE_ADD_TEST(suite, TestIndexByteArray);
