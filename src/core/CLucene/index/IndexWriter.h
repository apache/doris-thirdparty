...
CL_CLASS_DEF(analysis,SAnalyzer)
...
class CLUCENE_EXPORT IndexWriter:LUCENE_BASE {
  ...
  //CL_NS(analysis)::SAnalyzer* sanalyzer;
...
public:
  ...
  DEFINE_CONDITION(THIS_WAIT_CONDITION)
     ...
     *     index indicates doc id of source index
     *     the pair:
    ...
    void setDocumentWriter(IDocumentsWriter* doc_writer) {
...
protected:
  ...
  SegmentInfos* getSegmentInfos() { return segmentInfos; }
