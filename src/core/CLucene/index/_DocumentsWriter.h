...
class IDocumentsWriter {
public:
    virtual std::string getSegment() = 0;
    virtual int32_t getDocStoreOffset() = 0;
    virtual int32_t getNumBufferedDeleteTerms() = 0;
    virtual void setMaxBufferedDocs(int32_t count) = 0;
    virtual void setInfoStream(std::ostream *infoStream) = 0;
    virtual void setRAMBufferSizeMB(float_t mb) = 0;
    virtual void setMaxBufferedDeleteTerms(int32_t _maxBufferedDeleteTerms) = 0;
    virtual int32_t getMaxBufferedDeleteTerms() = 0;
    virtual bool hasDeletes() = 0;
    virtual void close() = 0;
    virtual const std::vector<std::string> &files() = 0;
    virtual std::string closeDocStore() = 0;
    ...
    virtual const std::vector<std::string> *abortedFiles() = 0;
    virtual bool bufferDeleteTerm(Term *term) = 0;
    virtual bool pauseAllThreads() = 0;
    virtual void resumeAllThreads() = 0;
    virtual int32_t getNumDocsInRAM() = 0;
    virtual int32_t flush(bool _closeDocStore) = 0;
    virtual void createCompoundFile(const std::string &segment) = 0;
    virtual void clearBufferedDeletes() = 0;
    virtual const TermNumMapType& getBufferedDeleteTerms() = 0;
    virtual int32_t getMaxBufferedDocs() = 0;
    virtual float_t getRAMBufferSizeMB() = 0;
    virtual bool bufferDeleteTerms(const CL_NS(util)::ArrayBase<Term*>* terms) = 0;
    virtual const std::string& getDocStoreSegment() = 0;
 ...
 */
class DocumentsWriter : public IDocumentsWriter {
private:
  IndexWriter* writer;
