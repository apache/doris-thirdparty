...
Hits* Searcher::search(Query* query, size_t n) {
    return _CLNEW Hits(this, query, (Filter*)NULL, (Sort*)NULL, n);
}
...
Hits* Searcher::search(Query* query, const Sort* sort, size_t n){
	return _CLNEW Hits(this, query, NULL, sort, n);
}
