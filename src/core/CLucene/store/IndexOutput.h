...
public:
	...
	*/
    ...
    virtual void writeBytes(const uint8_t* b, const int32_t length, const int32_t offset) = 0;
...
public:
	...
	*/
	void writeBytes(const uint8_t* b, const int32_t length) override;

    void writeBytes(const uint8_t* b, const int32_t length, const int32_t offset) override;
