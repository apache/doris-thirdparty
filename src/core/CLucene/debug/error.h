 ...
 */
#else
class CLUCENE_EXPORT CLuceneError : public std::exception
{
#ifndef _ASCII
	char* _awhat;
#endif
...
public:
 ...
 #define _CLTHROW_NOT_IMPLEMENT {char buffer[50];sprintf(buffer, "%s not implemented",__func__);_CLTHROWA(CL_ERR_UnsupportedOperation, buffer);}
