...
//CL_CLASS_DEF(analysis,STokenStream)
...
public:
    ...
    */
	...
	enum Index{
	    //for chinese, using: INDEX_CHN | INDEX_TOKENIZED
	    INDEX_CHS=8,
  ...
  virtual ~Field();
	...
	* binaryValue() must be set. */
    ...
    virtual const void* rawStringValue();
    virtual size_t getFieldDataLength();
	...
	* readerValue(), binaryValue(), and tokenStreamValue() must be set. */
    ...
    //virtual CL_NS(analysis)::STokenStream* stokenStreamValue();
	...
	* @memory Caller is responsible for releasing value if duplicateValue == false */
    ...
    void setValue(char* value, size_t fieldDataLen);
