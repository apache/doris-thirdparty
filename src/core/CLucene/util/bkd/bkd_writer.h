...
namespace bkd {
    ...
    public:
        ...
        /*void Build(int32_t nodeID, int32_t leafNodeOffset,
                   MutablePointValuesPtr reader, int32_t from, int32_t to,
                   std::shared_ptr<store::IndexOutput>& out,
                   ...
                   std::vector<int32_t> &spareDocIds);*/
        void build(int32_t nodeID, int32_t leafNodeOffset,
        ...
        /*void write_leaf_block_packed_values(store::IndexOutput *out, std::vector<int32_t> &common_prefix_lengths,
