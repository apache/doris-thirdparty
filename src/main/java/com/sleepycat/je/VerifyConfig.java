...
public class VerifyConfig implements Cloneable {
     ...
     *
     * <p>Setting this param to true to true currently disables other types
     ...
     * in a future release, the exclusivity will be removed.</p>
     *
     ...
     *
     * <p>The following WARNING-level message is logged when the extinction
     ...
     * reserved files."</p>
     *
     * <p>The following WARNING-level message is logged when a lock timeout
    ...
    public VerifyConfig setRepairReservedFiles(boolean repair) {
        setRepairReservedFilesVoid(repair);
        return this;
    }
