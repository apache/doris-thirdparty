...
public class DbBackup {
    ...
    public synchronized void startBackup()
        ...
        try {
            /*
             * Abort file erasure before the file flip to ensure that files
             * are not modified during the backup or network restore.
             * FUTURE: We unconditionally abort any erasure in progress here
             * and therefore the abortErase param could be removed.
             */
